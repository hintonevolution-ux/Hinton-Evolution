          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <a href="mailto:hintonevolution@gmail.com" className="font-medium text-white text-sm md:text-base hover:text-[#00e5ff] transition-colors">
            ...
            <div className="flex items-start gap-4 group">
              <div className="w-12 h-12 rounded-2xl bg-[#12121D] border border-white/5 flex items-center justify-center text-[#25D366] shrink-0 group-hover:border-[#25D366]/40 transition-all duration-300">
                <Phone size={20} />
              </div>
              <div>
                ...
                <div className="font-medium text-white text-sm md:text-base flex flex-col sm:flex-row gap-x-3 gap-y-1">
                  <a href="tel:+919832727520" className="whitespace-nowrap hover:text-[#00e5ff] transition-colors">
                    📞 +91 98327 27520
                  </a>
                  <span className="whitespace-nowrap hidden sm:inline text-white/20">|</span>
                  <a href="https://wa.me/918001891036" target="_blank" rel="noopener noreferrer" className="whitespace-nowrap text-[#25D366] hover:underline flex items-center gap-1">
                    💬 +91 80018 91036
                  </a>
                </div>
              </div>
            ...
            <div className="pt-2">
              <a
                href="https://wa.me/918001891036?text=Hi%20Hinton%20Evolution%2C%20I%20would%20like%20to%20inquire%20about%20a%20website%20project."
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackEvent('click_whatsapp', { location: 'contact_page' })}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-black font-bold px-7 py-3.5 rounded-2xl shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:shadow-[0_0_30px_rgba(37,211,102,0.5)] hover:scale-105 active:scale-95 transition-all duration-200 text-sm"
              >
                <span className="text-xl leading-none">💬</span>
                <span>Chat on WhatsApp (+91 80018 91036)</span>
                <ArrowRight size={16} />
              </a>
            </div>
          </div>
